...
public class MainActivity extends AppCompatActivity {
    ...
    public void drawSomething(View view) {
        ...
        Log.d(TAG, "drawSomething mOffset: " + mOffset);
        Log.d(TAG, "drawSomething halfHeight: " + halfHeight);
        Log.d(TAG, "drawSomething halfWidth: " + halfWidth);
        Log.d(TAG, "drawSomething paintColor: " + mPaint.getColor());
